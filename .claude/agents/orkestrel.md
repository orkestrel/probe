...
| `@orkestrel/mcp`        | `0.0.31` | L4    | `@orkestrel/sse` `^0.0.7`, `@orkestrel/tool` `^0.0.15`, `@orkestrel/codec` `^0.0.3`, `@orkestrel/emitter` `^0.0.10`, `@orkestrel/process` `^0.0.12`, `@orkestrel/contract` `^0.0.17`, `@orkestrel/websocket` `^0.0.12`                                                                                                     | `@orkestrel/router` `^0.0.14`, `@orkestrel/server` `^0.0.19`   |
